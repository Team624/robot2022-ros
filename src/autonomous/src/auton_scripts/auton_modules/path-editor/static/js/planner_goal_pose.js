...
//   if (autonData.paths[currentSelctedPathIndex].position_x == null){
//     document.getElementById("PoseGoalDataXInput" + x).placeholder = "Select X Pose";
//   }
//   else{
//     document.getElementById("PoseGoalDataXInput" + x).defaultValue = autonData.paths[currentSelctedPathIndex].position_x;
//   }

//   if (autonData.paths[currentSelctedPathIndex].position_y == null){
//     document.getElementById("PoseGoalDataYInput" + x).placeholder = "Select Y Pose";
//   }
//   else{
//     document.getElementById("PoseGoalDataYInput" + x).defaultValue = autonData.paths[currentSelctedPathIndex].position_y;
//   }

//   if (autonData.paths[currentSelctedPathIndex].th == null){
//     document.getElementById("PoseGoalDataThInput" + x).placeholder = "Select Th Pose";
//   }
//   else{
//     document.getElementById("PoseGoalDataThInput" + x).defaultValue = autonData.paths[currentSelctedPathIndex].th;
//   }
// }
...
//     inputValX = null;
//   }
//   autonData.paths[currentSelctedPathIndex].position_x = inputValX

//   var inputValY = parseFloat(document.getElementById("PoseGoalDataYInput" + x).value);
//   if (inputValY == ""){
//     inputValY = null;
//   }
//   autonData.paths[currentSelctedPathIndex].position_y = inputValY

//   var inputValTh = parseFloat(document.getElementById("PoseGoalDataThInput" + x).value);
//   if (inputValTh == ""){
//     inputValTh = null;
//   }
//   autonData.paths[currentSelctedPathIndex].th = inputValTh
