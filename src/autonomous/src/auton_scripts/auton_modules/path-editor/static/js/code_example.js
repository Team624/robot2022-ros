class CodeExample {
    constructor() {
        var cvs = this.cvs = document.getElementById("mycanvas");;
        cvs.width = document.getElementById('field').clientWidth;
        cvs.height = document.getElementById('field').clientHeight;
