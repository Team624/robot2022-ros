...
auton_id = 6
auton_title = "Auton Steal Left Init"
...
class StartThirdPath(StartPath): #Moving towards the goal with a total of 5 balls (4 seconds)
    """
    The state which publishes the first path to follow
    """
...
class DeployIntake2(Intake): # This steals the left side's two balls (2 seconds)
    """
    The state which publishes the first path to follow
    """
